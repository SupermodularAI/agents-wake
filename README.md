...
Existing history is not imported by default. `wake init --full` imports this
project's Claude Code history in the same call, and `wake ingest` does it
afterwards for a project that is already consented.
